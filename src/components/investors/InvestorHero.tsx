      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-10 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
            <Link
              href="/contact"
              className="bg-[#8B0000] text-white px-8 py-4 rounded-full font-semibold text-sm tracking-wide shadow-lg hover:bg-[#700000] hover:-translate-y-0.5 transition-all duration-300 inline-flex items-center justify-center"
            >
              Request Investor Deck
            </Link>
            <Link
              href="/contact"
              className="bg-transparent border border-gray-500 text-white px-8 py-4 rounded-full font-semibold text-sm tracking-wide hover:border-white hover:bg-white/5 transition-all duration-300 inline-flex items-center justify-center"
            >
