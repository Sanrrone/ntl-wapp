  ...
  return (
    <section className="w-full bg-white py-24 px-6 border-t border-gray-100">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <div className="text-[0.7rem] font-bold tracking-widest uppercase text-[#B98A45]">Next Step</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4 w-full">
            <button className="bg-[#8B0000] text-white px-8 py-4 rounded-full font-semibold text-sm tracking-wide shadow-md hover:bg-[#700000] hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto">
              Request Investor Deck
            </button>
            <button className="bg-white border border-gray-300 text-[#111C18] px-8 py-4 rounded-full font-semibold text-sm tracking-wide hover:border-gray-400 hover:bg-gray-50 transition-all duration-300 w-full sm:w-auto">
